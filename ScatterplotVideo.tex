...
(The attach command makes the variables in the data frame
SLR1 accessible by name rather than using the $ notation). Need
to be careful as if there are other variables in use with the same
names as those in the data frame, R will get confused. When
