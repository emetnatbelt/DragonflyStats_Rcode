...
This component is 50% of overall module.

Your grade is based on 
a) Project work , i.e. two projects with a combined mark of 25%
b) Short in-class homeworks (10%)
c) A short in-class exam (15%) at the end of the semester.

Project 4a: Packages

The first project  (worth 5%) is a short report on an R package (or group of R packages). 
...
This project is worth 20% of the overall mark.
